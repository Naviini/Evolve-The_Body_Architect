/**
 * BodyModel3DCanvas.web — Three.js on WebGL (browser)
 *
 * Loaded only via dynamic import from BodyModel3D.web.tsx so expo-router’s
 * route scan never evaluates Three.js at startup.
 */
    ...
    return (
        <View style={[styles.container, { width, height }]}>
            ...
            >
                ...
                <spotLight position={[0, -0.5, 5]} angle={0.55} penumbra={0.85} intensity={1.1} color={accentColor} decay={2} />
